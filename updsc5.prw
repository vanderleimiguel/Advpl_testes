...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt.Exec.Serv'															, ; //X3_TITULO
	'Dt.Exec.Serv'															, ; //X3_TITSPA
	'Dt.Exec.Serv'															, ; //X3_TITENG
	'Dt.Exec.Servico'														, ; //X3_DESCRIC
	'Dt.Exec.Servico'														, ; //X3_DESCSPA
	'Dt.Exec.Servico'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Data de execução do servico' )

aHlpEng := {}
aAdd( aHlpEng, 'Data de execução do servico' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Data de execução do servico' )

PutSX1Help( "PC5_DTESERV", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C5_DTESERV" )
