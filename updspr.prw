...
/*/
//--------------------------------------------------------------------
User Function UPDSPR( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZZ1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZZ1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SA1",1,xfilial("SA1")+ZZ1->ZZ1_COD,"A1_NOME")'			, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'ZZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZZ1_PUPILA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Clas. Pupila'														, .T. }, ; //X3_TITULO
	{ 'Clas. Pupila'														, .T. }, ; //X3_TITSPA
	{ 'Clas. Pupila'														, .T. }, ; //X3_TITENG
	{ 'Classificação da pupila'												, .T. }, ; //X3_DESCRIC
	{ 'Classificação da pupila'												, .T. }, ; //X3_DESCSPA
	{ 'Classificação da pupila'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ 'x'																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Basico;2=Avancado;3=Premium'										, .T. }, ; //X3_CBOX
	{ '1=Basico;2=Avancado;3=Premium'										, .T. }, ; //X3_CBOXSPA
	{ '1=Basico;2=Avancado;3=Premium'										, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'U_Pupila()'															, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'ZZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZZ1_RESTR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Restricao'															, .T. }, ; //X3_TITULO
	{ 'Restricao'															, .T. }, ; //X3_TITSPA
	{ 'Restricao'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'ZZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZZ1_CCURSO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cód. Curso'															, .T. }, ; //X3_TITULO
	{ 'Cód. Curso'															, .T. }, ; //X3_TITSPA
	{ 'Cód. Curso'															, .T. }, ; //X3_TITENG
	{ 'Código do curso'														, .T. }, ; //X3_DESCRIC
	{ 'Código do curso'														, .T. }, ; //X3_DESCSPA
	{ 'Código do curso'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZZ1_CURSO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 30																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Desc. Curso'															, .T. }, ; //X3_TITULO
	{ 'Desc. Curso'															, .T. }, ; //X3_TITSPA
	{ 'Desc. Curso'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SB1",1,xfilial("SB1")+ZZ1->ZZ1_CCURSO,"B1_DESC")'			, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data Concl.'															, .T. }, ; //X3_TITULO
	{ 'Data Concl.'															, .T. }, ; //X3_TITSPA
	{ 'Data Concl.'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'ZZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'ZZ1_CODCID'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod. Cidade'															, .T. }, ; //X3_TITULO
	{ 'Cod. Cidade'															, .T. }, ; //X3_TITSPA
	{ 'Cod. Cidade'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSIX, { ;
	'ZZ1'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZZ1_FILIAL+ZZ1_NOME'													, ; //CHAVE
	'Nome Cliente+Filial+Nome Cliente'										, ; //DESCRICAO
	'Nome Cliente+Sucursal+Nome Cliente'									, ; //DESCSPA
	'Nome Cliente+Sucursal+Nome Cliente'									, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSX7, { ;
	'ZZ1_CCURSO'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SB1",1,XFILIAL("SB1")+M->ZZ1_CCURSO,"B1_TIPO")'				, ; //X7_REGRA
	'ZZ1_TIPO'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'ZZ1_COD'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SA1",1,XFILIAL("SA1")+M->ZZ1_COD,"A1_CGC")'					, ; //X7_REGRA
	'ZZ1_CPF'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDZZ1" ) ) ) ;
